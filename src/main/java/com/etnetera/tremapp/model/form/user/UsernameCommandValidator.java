...
public class UsernameCommandValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "username", "username.validation.username.required");
		...
		if (userByUsername != null && (editedUser != null || !userByUsername.getId().equals(editedUser.getId()))) {
			errors.rejectValue("username", "username.validation.username.unique");
		}
	} 
